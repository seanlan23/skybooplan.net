...
const REGION_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  sidemen: { lat: -8.478, lng: 115.443 },
  amed: { lat: -8.333, lng: 115.633 },
  "nusa lembongan": { lat: -8.679, lng: 115.451 },
  lembongan: { lat: -8.679, lng: 115.451 },
  "nusa dua": { lat: -8.801, lng: 115.231 },
  uluwatu: { lat: -8.829, lng: 115.085 },
  "gili trawangan": { lat: -8.351, lng: 116.039 },
  "gili islands": { lat: -8.35, lng: 116.04 },
  "gili air": { lat: -8.358, lng: 116.082 },
  "gili meno": { lat: -8.352, lng: 116.056 },
  lombok: { lat: -8.65, lng: 116.325 },
