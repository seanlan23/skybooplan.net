...
- days[].city = mesto NOČITVE tiste noči (hotel/kamp) — NE vstopno letališko mesto za vsak dan. Na dnevu premika v NOVO bazo je city NOVO mesto OD TISTEGA DNEVA DALJE. Bližnji otoki/kraji = enodnevni izleti z glavne baze, brez 1-nočne menjave hotela. PREPOVEDANO pustiti prejšnje mesto na dnevih po premiku. Zaporedni dnevi v isti bazi MORAJU imeti isto city. PREPOVEDANO: enodnevni skok nazaj na prejšnje vozlišče brez transferja tisti dan (npr. A–A–B–A).
