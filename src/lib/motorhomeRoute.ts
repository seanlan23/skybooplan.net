...
const MAP_PLACE_COUNTRY_HINT: Array<{ test: RegExp; query: string }> = [
  ...
  { test: /^gjirokast[eë]r$|^girokastra$|^gjirokaster$/i, query: "Gjirokastër, Albania" },
  { test: /^tirana$/i, query: "Tirana, Albania" },
  { test: /^ksamil$/i, query: "Ksamil, Albania" },
  { test: /^vlor[eë]$|^vlora$|^vlore$/i, query: "Vlorë, Albania" },
  { test: /^kotor$/i, query: "Kotor, Montenegro" },
  { test: /^budva$/i, query: "Budva, Montenegro" },
  { test: /^mostar$/i, query: "Mostar, Bosnia and Herzegovina" },
  { test: /^ohrid$/i, query: "Ohrid, North Macedonia" },
  { test: /^skopje$|^skopye$/i, query: "Skopje, North Macedonia" },
  { test: /^beograd$|^belgrade$/i, query: "Belgrade, Serbia" },
  { test: /^budimpe[sš]ta$|^budapest$/i, query: "Budapest, Hungary" },
  { test: /^dunaj$|^vienna$|^wien$/i, query: "Vienna, Austria" },
